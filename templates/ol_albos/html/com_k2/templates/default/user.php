...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="userBlock">
		...
		<span class="userItemAddLink">
			<a class="base" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->addLink; ?>">
			...
			<div class="userItemHeader">			
			  ...
			  <h3 class="userItemTitle">
					...
					<span class="userItemEditLink">
						<a class="base" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $item->editLink; ?>">
