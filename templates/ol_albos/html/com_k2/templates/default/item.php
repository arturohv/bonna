	...
	<div class="itemHeader">
	  ...
	  <h2 class="itemTitle">
			...
			<span class="itemEditLink">
				<a class="base" rel="{handler:'iframe',size:{x:990,y:550}}" href="<?php echo $this->item->editLink; ?>">
  ...
  <div class="itemBody">
	  ...
	  <div class="itemImageBlock">
		  <span class="itemImage">
		  	<a class="base" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
		    ...
		    <p><?php echo $comment->commentText; ?></p>
				...
				<span class="commentToolbar">
					...
					<a class="base" rel="{handler:'iframe',size:{x:560,y:480}}" href="<?php echo JRoute::_('index.php?option=com_k2&view=comments&task=report&commentID='.$comment->id)?>"><?php echo JText::_('K2_REPORT')?></a>
					<?php endif; ?>
